-- Dodatne zasebne kategorije za kućne režije (utilities) kako bi korisnik
-- mogao preciznije pratiti troškove vode, struje, grijanja, televizije,
-- komunalne naknade, odvoza smeća i kućnog interneta.
-- Idempotentno: postojeće baze dobiju kategorije bez duplikata.
