          ...
          <Card className="p-6 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Vidljivo samo vlasniku aplikacije. Procijenite mjesečni trošak Lovable kredita prema broju korisnika i očekivanom broju AI skeniranja te dobijte preporuku plana.
                </p>
              </div>
            </div>
            <SubscriptionWizard />
